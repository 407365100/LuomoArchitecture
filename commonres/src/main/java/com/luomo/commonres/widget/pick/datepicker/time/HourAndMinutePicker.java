package com.luomo.commonres.widget.pick.datepicker.time;
...
public class HourAndMinutePicker extends LinearLayout implements
    ...
    private void initAttrs(Context context, @Nullable AttributeSet attrs) {
        ...
        int selectedItemTextColor = a.getColor(R.styleable.HourAndMinutePicker_selectedTextColor,
                getResources().getColor(R.color.lib_base_datepicker_selectedTextColor));
        ...
        int curtainBorderColor = a.getColor(R.styleable.HourAndMinutePicker_wheelCurtainBorderColor,
                getResources().getColor(R.color.lib_base_datepicker_divider));
        a.recycle();
    ...
    private void initChild() {
        mHourPicker = (HourPicker) findViewById(R.id.hourPicker_layout_time);
        mHourPicker.setOnHourSelectedListener(this);
        mMinutePicker = (MinutePicker) findViewById(R.id.minutePicker_layout_time);
