...
import com.luomo.base.utils.KeyboardUtil;
...
public class PayPsdInputView extends android.support.v7.widget.AppCompatEditText {
    ...
    private void getAtt(AttributeSet attrs) {
        ...
        borderColor = typedArray.getColor(R.styleable.PayPsdInputView_borderColor, borderColor);
...
//       super.onDraw(canvas);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        KeyboardUtil.hideSoftInput(mContext,this);
        return true;
    }
