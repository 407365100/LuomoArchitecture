package com.luomo.commonres.widget.pick.datepicker.date;
...
public class DatePicker extends LinearLayout implements YearPicker.OnYearSelectedListener, MonthPicker.OnMonthSelectedListener, DayPicker.OnDaySelectedListener {
	...
	private void initAttrs(Context context, @Nullable AttributeSet attrs) {
		...
		int dateType = a.getInteger(R.styleable.DatePicker_dateType,1);
		a.recycle();
	...
	private void initChild() {
		mYearPicker = (YearPicker) findViewById(R.id.yearPicker_layout_date);
		mYearPicker.setOnYearSelectedListener(this);
		mMonthPicker = (MonthPicker) findViewById(R.id.monthPicker_layout_date);
		mMonthPicker.setOnMonthSelectedListener(this);
		mDayPicker = (DayPicker) findViewById(R.id.dayPicker_layout_date);
