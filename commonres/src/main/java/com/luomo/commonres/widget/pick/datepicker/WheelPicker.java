package com.luomo.commonres.widget.pick.datepicker;
...
import com.luomo.commonres.R;
import com.luomo.commonres.widget.pick.datepicker.util.LinearGradient;
...
//				}
	...
	private void initAttrs(Context context, @Nullable AttributeSet attrs) {
		...
		mSelectedItemTextColor = a.getColor(R.styleable.WheelPicker_selectedTextColor, Color.parseColor("#fbb038"));
        ...
        mCurtainColor = a.getColor(R.styleable.WheelPicker_wheelCurtainColor,Color.parseColor("#30fbb038"));
	...
	protected void onDraw(Canvas canvas) {
		...
		for (int drawDataPos = drawnSelectedPos - mHalfVisibleItemCount - 1;
			...
			} else if(TYPE_DATA == 2){//省市数据显示
				if(data instanceof RegionDomain) {
					RegionDomain regionDomain = (RegionDomain) data;
					canvas.drawText(regionDomain.getRegionName(), mFirstItemDrawX, itemDrawY, mPaint);
				}
			}
		}
